...
class HomePage extends Component {
    ...
    onEnterFirst = (val) => {
        if (val.previousPosition === "above") {
            $(".nav-logo-image").attr("src", White_logo);
        } else {
        }
    }
    onLeaveFirst = (val) => {
        $(".nav-logo-image").attr("src", Red_logo);
    }
                                            ...
                                            <Col className="form-col">
                                                <div className="contact-form-container" >
                                                    ...
                                                    <Form className="contact-form" onSubmit={this.handleSubmit}>
                                                        ...
                                                        <p className="terms">This advertisement is not an offering. It is a solicitation of interest in the advertised property. No offering of the advertised units can be made and no deposits can be accepted, or reservations, binding or  non-binding, can be made until an offering plan is filed with the New York State Department of Law. This advertisement is made pursuant to Cooperative Policy Statement #1, issued by the New York State Department of Law.  File No. CP19-0038.  Sponsor: 157-161 East 28th Street LLC, c/o Coral Realty, 400 Broome Street, 11th Floor, New York, New York 10013.</p>
                                                    </Form>
